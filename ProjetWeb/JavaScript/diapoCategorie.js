...
async function translateDiapo(myElement,value,button){
    ...
    if(ntranslat <= 0 && ntranslat >=(-3*3*295)){
...
window.onload = function(){
    ...
    //les images du slideShow
    let firstSlide = $(".slideShow div:first-child");
    let secondSlide = $(".slideShow div:nth-child(2)");
    let thirdSlide = $(".slideShow div:nth-child(3)");
    let fourthSlide = $(".slideShow div:nth-child(4)");
    let slides = $('.slide');
    console.log("hello")
    console.log(slides.length())
    // Tableau contenant tous les images
    let range = [firstSlide,secondSlide,thirdSlide,fourthSlide];
